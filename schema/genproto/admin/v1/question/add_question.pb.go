...
func (x *AddQuestionRequest) Reset() {
	*x = AddQuestionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_add_question_proto_msgTypes[0]
...
func (*AddQuestionRequest) Descriptor() ([]byte, []int) {
	return file_add_question_proto_rawDescGZIP(), []int{0}
}
...
func (x *AddQuestionRequest) GetTag() []string {
	if x != nil {
		return x.Tag
	}
	return nil
...
func (x *AddQuestionRequest) GetDegree() int32 {
	if x != nil {
		return x.Degree
	}
	return 0
...
func (x *AddQuestionRequest) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *AddQuestionResponse) Reset() {
	*x = AddQuestionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_add_question_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_add_question_proto_rawDesc = []byte{
	0x0a, 0x12, 0x61, 0x64, 0x64, 0x5f, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70,
	...
	0x74, 0x61, 0x67, 0x67, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x02, 0x0a,
	0x12, 0x41, 0x64, 0x64, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x6c, 0x65, 0x12, 0x31, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x18,
	...
	0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x04, 0x20,
	...
	0x67, 0x12, 0x2f, 0x0a, 0x06, 0x64, 0x65, 0x67, 0x72, 0x65, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
...
var (
	file_add_question_proto_rawDescOnce sync.Once
	file_add_question_proto_rawDescData = file_add_question_proto_rawDesc
)

func file_add_question_proto_rawDescGZIP() []byte {
	file_add_question_proto_rawDescOnce.Do(func() {
		file_add_question_proto_rawDescData = protoimpl.X.CompressGZIP(file_add_question_proto_rawDescData)
	})
...
func init() { file_add_question_proto_init() }
func file_add_question_proto_init() {
	if File_add_question_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_add_question_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_add_question_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_add_question_proto_goTypes,
		DependencyIndexes: file_add_question_proto_depIdxs,
		MessageInfos:      file_add_question_proto_msgTypes,
	}.Build()
	File_add_question_proto = out.File
	file_add_question_proto_rawDesc = nil
	file_add_question_proto_goTypes = nil
	file_add_question_proto_depIdxs = nil
}
